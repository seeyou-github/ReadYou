        ...
        Column(
            ...
            Column(
                ...
                Row(
                    ...
                    val primaryColorButtonColor = if (selectedTab == 2) {
                        MaterialTheme.colorScheme.primary
                    } else {
                        MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f)
                    }
                ...
                Box(
                    ...
                    Column(
                        ...
                        Button(
                            ...
                            Text("主题色按钮预览", color = Color.White)
                        }
                    }
                }
                    ...
                    Button(
                        onClick = {
                            ...
                            scope.launch {
                                ...
                                FeedsPageColorThemesPreference.put(
                                    context,
                                    scope,
                                    updatedThemes
                                )
